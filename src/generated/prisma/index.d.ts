...
export namespace Prisma {
  ...
  */
  ...
  export type RecordOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "score" | "testName" | "ts" | "userId", ExtArgs["result"]["record"]>
  ...
  interface RecordFieldRefs {
    ...
    readonly ts: FieldRef<"Record", 'BigInt'>
  ...
  export type RecordWhereInput = {
    ...
    ts?: BigIntFilter<"Record"> | bigint | number
  ...
  export type RecordScalarWhereWithAggregatesInput = {
    ...
    ts?: BigIntWithAggregatesFilter<"Record"> | bigint | number
