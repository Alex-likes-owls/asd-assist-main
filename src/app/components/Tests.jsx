...
export const Tests = ({ data }) => {
  return (
    <Link
      className="flex flex-col justify-evenly items-center md:w-[32%] bg-sky-100 hover:bg-blue-100 text-center m-7 rounded-lg"
    ...
    >
      <div className="h-[540px] flex flex-col justify-evenly items-center">
        ...
        <p className="font-bold text-3xl text-sky-600 underline">
          {data.title}
        </p>
